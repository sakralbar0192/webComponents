...
const iconSize: ISvgParams = {width: 18, height: 18}

export function refreshIcon({width, height}: ISvgParams = iconSize): TemplateResult {
    return html`
        <svg xmlns:xlink="http://www.w3.org/1999/xlink" height=${height} width=${width} viewBox="0 0 56.855 56.855">
