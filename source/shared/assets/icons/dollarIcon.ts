...
const iconSize: ISvgParams = {width: 16, height: 16}

export function dollarIcon({width, height}: ISvgParams = iconSize): TemplateResult {
    return html`
        <svg xmlns:xlink="http://www.w3.org/1999/xlink" height=${height} width=${width} viewBox="0 0 492 492">
